...
| `friend` | ともだち一覧・ともだち追加・二次元コード・合言葉 | `friend.list.title`, `friend.add.title`, `friend.add.passcode_title` |
...
| **マトリクス型二次元コード** | **二次元コード** | **QR code** | 日本語は半角数字「二次元コード」、英語は「QR code」で統一 |
...
- [x] **A03m テナント選択**: 二次元コード/URL/テキストタブ名、検証中/成功/失敗メッセージ
...
- [x] **C03 ともだち追加 (二次元コード / テキスト / 3桁合言葉)**: カメラスキャン案内、自二次元コード案内、3桁合言葉、残り時間、テキスト連携、エラー表示
